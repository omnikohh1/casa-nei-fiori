const puppeteer = require("puppeteer-core"); // Importante: usa puppeteer-core
...
async function getBrowser() {
    ...
    if (process.env.RENDER) {
        ...
        try {
            ...
            console.log("Il file esiste:", stats); // LOG - Informazioni sul file
        } catch (error) {
            console.error("Errore fs.stat:", error); // LOG - Mostra l'errore specifico (es. ENOENT)
        }
    }
    ...
    try {
        ...
        console.error("Opzioni di lancio:", launchOptions); // LOG - Mostra le opzioni di lancio complete
        throw error; // Rilancia l'errore per farlo gestire dal blocco catch esterno
    }
}
